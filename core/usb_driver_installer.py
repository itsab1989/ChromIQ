...
# so the certificate is trusted for everything on the machine, not only for
# drivers. `usb_installer_text()` in `ui/dialogs/settings_dialog.py` tells the
# user so before they click; this comment is the evidence behind that text.
#
