...
class SettingsDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        chartread_engine_tip = TooltipButton(
            ...
            "─────────────────────────────────\n\n"
            "                                  Engine   chartread\n"
            "  Identical measured values         yes        yes\n"
            "  Saved after every strip           yes         no\n"
            "  Click a strip to jump to it       yes         no\n"
            "  Live patch preview while          yes         no\n"
            "    measuring\n"
            "  Wrong-strip check on fixed-       yes         no\n"
            "    order charts\n"
            "  Reading time for each strip       yes         no\n"
            "  Too-fast warning and advice       yes         no\n"
            "  Offer to re-read a hurried        yes         no\n"
            "    strip\n"
            "  Argyll's own Slow Down cue        yes        yes\n"
            "  Right sound for the right         yes        yes\n"
            "    failure\n"
            "  Strip-failure window and          yes        yes\n"
            "    advice\n"
            "  Total measuring time in the       yes        yes\n"
            "    summary\n"
            "  Per-strip figures in the          yes         no\n"
            "    summary\n"
            "  Only ChromIQ sounds are heard     yes         no\n\n"
