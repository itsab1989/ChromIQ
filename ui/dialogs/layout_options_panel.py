        ...
        add_row(lgg, 0, tr("Create layout:"), self.layout_mode,
                tip=TooltipButton(
                    ...
                    tr("Two ways to decide patch size against how many fit. "
                       ...
                       "strip you want.\n"
                       "Here your margins are the law. The patch area lands "
                       "exactly where you defined it, which is what makes fine "
                       "control of the margins and the surrounding text "
                       "possible at all. A strip may also run past your "
                       "instrument's ruler, and ChromIQ warns you about it "
                       "rather than quietly shortening the strip.\n"
