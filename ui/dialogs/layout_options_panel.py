        ...
        add_row(lgg, 0, tr("Create layout:"), self.layout_mode,
                tip=TooltipButton(
                    ...
                    tr("Two ways to decide patch size against how many fit. "
                       ...
                       "   2. What the instrument needs at the edge of the "
                       "sheet. An i1Pro, a Pro-300 and a ColorMunki need "
                       "nothing there. A SpectroScan or a CR30 keeps about "
                       "8.5 mm at the left of an A4 sheet even when you ask "
                       "for none, and a little more on the clip side than the "
                       "band alone would take.\n"
