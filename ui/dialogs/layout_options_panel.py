    ...
    def __init__(self, parent: QWidget | None = None, *,
        ...
        self._show_indicators_tip = TooltipButton(
            ...
            tr("The small label printed above each strip so you always know "
               ...
               "straight.\n\n"
               "Where they sit. They hang from the top edge of the paper at "
               "the distance you set in “Top” under “Text distance from "
               "edge”, and they never slide down into the patches. If the top "
               "margin is too small to hold a whole label, the label moves up "
               "towards the paper edge rather than over the first row. "
               "Example, A4 portrait with “Top” at 4 mm and letters about "
               "7 mm tall: with a 15 mm top margin the letters are printed "
               "between 4 mm and 11 mm from the top edge, leaving 4 mm of air "
               "above the first row of patches. Narrow the top margin to "
               "10 mm and there is no longer room for both, so the letters "
               "move up to between 3 mm and 10 mm, which is closer to the "
               "paper edge than the 4 mm you asked for, and that is reported "
               "under the preview.\n\n"
               "The band is as tall as the letters at the size you chose and "
               "it lives inside the top margin, so switching this on can "
               "leave room for fewer or slightly smaller patches. If the top "
               "margin cannot hold it, that is reported under the preview.\n\n"
               "The row indicators down the left-hand side work the same way, "
               "with “Clip” in place of “Top”. Their own help has the "
               "arithmetic. Set the font, size and underline style in "
        ...
        self._show_row_indicators_tip = TooltipButton(
            ...
            tr("Prints a label down the left-hand side of the chart for every "
               ...
               "at a time, such as a SpectroScan or a CR30, which is why those "
               "two have always printed it. You can also switch the strip letters "
               ...
               "border's width instead whenever that is the larger of the "
               ...
               "1 mm after it. Two worked examples, both A4 portrait:\n"
               "  •  No clip border, “Clip” set to 4 mm, two-digit numbers "
               "about 5 mm wide. The labels start 4 mm in from the paper "
               "edge, the band is 6 mm wide, and the patches start at 11 mm. "
               "Ask for a 6 mm left margin and you get 11 mm.\n"
               "  •  A 26 mm clip border on the left, the same labels. The "
               "labels start at 26 mm, because the border is wider than "
               "“Clip”, and the patches start at 33 mm. Ask for a 26 mm left "
               ...
               "need, the space that is left over stays between the labels "
               "and the patches instead of dragging the labels along. On a chart "
               ...
               "only slivers of them. And if the left margin is not wide "
               "enough for both, the patches keep their place and the labels "
               "are pushed up against them. Line the three settings up: give "
               "the left margin at least “Clip” plus the label width plus "
               "2 mm, and set “Clip” to at least the clip border width plus "
               "1 mm.\n\n"
               "The labels restart at the first one on every page. Set their "
               "font and size in Preferences → Chart Layout."), self)
        ...
        add_row(lgg, 0, tr("Create layout:"), self.layout_mode,
                tip=TooltipButton(
                    ...
                    tr("Two ways to decide patch size against how many fit. "
                       ...
                       "strip you want.\n"
                       "Here your margins are kept, not treated as a "
                       "starting point, and that is what makes fine control of "
                       "the margins and the surrounding text possible at all. "
                       "One thing still moves a sheet off the exact numbers "
                       "you typed: a whole number of patches rarely fills the "
                       "area exactly, and the space left over has to go "
                       "somewhere. Down the page it is shared, so top and "
                       "bottom come out equal to each other and a little "
                       "larger than you asked, often a millimetre or two. "
                       "Across the page it all goes to the LEFT: the right "
                       "margin is exactly the number you typed and the left "
                       "one takes the remainder, until the number you type is "
                       "the larger of the two. Measured on a 120-patch A4 "
                       "sheet, asking 5 mm all round gives a left margin of "
                       "26 mm and a right margin of 5, while asking 40 mm "
                       "gives 40 on both. The “Measured from Preview” panel "
                       "always shows what the sheet really got.\n"
