        ...
        add_row(lgg, 0, tr("Create layout:"), self.layout_mode,
                tip=TooltipButton(
                    ...
                    tr("Two ways to decide patch size against how many fit. "
                       ...
                       "Each side ends up the LARGEST of three things:\n"
                       "   1. The number you type.\n"
                       "   2. The clip border's width, on the side it is "
                       "printed on. On the default sheet that band is 26 mm "
                       "and sits on the left, so a 5 mm left margin comes out "
                       "at 26 while 40 stays 40. Move the band to the right "
                       "under Clip-border content and the same happens to the "
                       "right margin instead.\n"
                       "   3. What your instrument needs to reach the patches "
                       "at all. It is nothing on an i1Pro, and it is the "
                       "larger claim on a ColorMunki, a SpectroScan or a CR30: "
                       "asking for 5 mm on an A4 SpectroScan sheet gives 30 mm "
                       "on the left and 9 on the right, with or without the "
                       "band.\n"
                       "Down the page a little is added as well, because the "
                       "block is centred between two reserves that are not the "
                       "same size: the strip letters above the patches and the "
                       "run-out below them. Top and bottom therefore come out "
                       "slightly larger than you asked, and not by the same "
                       "amount as each other.\n"
