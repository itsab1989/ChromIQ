...
# .ti1, byte-identical), offered as six ready starting points.
#
# EVERY VALUE BELOW IS KNUT'S, COPIED FROM THE PRESET FILES HE EXPORTED, AND
# THERE IS DELIBERATELY NO SHARED BASE DICT. There used to be one
# (`_REDRIVER_BASE`), and it is what broke these charts: a later change wrote
# one `helper_marker_per_patch` across the base and silently overwrote the
# per-chart values he had chosen on paper (5 on the i1Pro charts, 7 on
# ColorMunki A4 8-pages). His verdict, 4.1.3-beta.16: *"The red river presets
# were manipulated by the AI, changing the settings and markings. … They must
# be implemented as is. The margins etc are different for Colormunki and
# i1Pro."* Six independent dicts cannot drift together; a base can.
#
# Only ONE value is not his verbatim: `clip_image_path`, which his export
# carries as an absolute path into his installed .app and which must resolve
# through resource_path here. `tests/test_redriver_presets_are_knuts.py`
# compares every other field against his files, which are committed under
# `tests/fixtures/redriver_presets_v25/`.
_REDRIVER_SUFFIX = " · Standard Patch Set v25"
_REDRIVER_DIR = "assets/charts/redriver/rgb/standard_patch_set_v25"

# i1Pro-A4-2052p-4pages — Knut's export, verbatim.
_RR_I1PRO_A4_2052P_4PAGES: dict = {
    'instrument': 'i1',
    'paper': 'A4',
    'dpi': 300,
    'randomize': True,
    ...
    'indicator_bold': False,
    'indicator_italic': False,
    'indicator_rotation': 0,
    'indicator_align': 'left',
    'strip_label_offset_mm': 0.0,
    'underline_mode': 'off',
    'underline_thickness_mm': 0.5,
    'underline_gap_mm': 0.5,
    'chart_text': '',
...
# i1Pro-Letter-2052p-4pages — Knut's export, verbatim.
_RR_I1PRO_LETTER_2052P_4PAGES: dict = {
    'instrument': 'i1',
    'paper': 'Letter',
    'dpi': 300,
    'randomize': True,
...
# ColorMunki-A4-2052p-8pages — Knut's export, verbatim.
_RR_COLORMUNKI_A4_2052P_8PAGES: dict = {
    'instrument': 'CM',
    'paper': 'A4',
    'dpi': 300,
    'randomize': True,
...
# ColorMunki-Letter-2052p-8pages — Knut's export, verbatim.
_RR_COLORMUNKI_LETTER_2052P_8PAGES: dict = {
    'instrument': 'CM',
    'paper': 'Letter',
    'dpi': 300,
    'randomize': True,
...
# ColorMunki-A4-2052p-9pages — Knut's export, verbatim.
_RR_COLORMUNKI_A4_2052P_9PAGES: dict = {
    'instrument': 'CM',
    'paper': 'A4',
    'dpi': 300,
    'randomize': True,
...
# ColorMunki-Letter-2052p-9pages — Knut's export, verbatim.
_RR_COLORMUNKI_LETTER_2052P_9PAGES: dict = {
    'instrument': 'CM',
    'paper': 'Letter',
    'dpi': 300,
    'randomize': True,
...
class _Ti1Preset:
    ...
    def combo_label(self) -> str:
        ...
        return f"★  {self.file_group} · {self.marked_name}  ·  built-in"
...
KNUT_PRESETS: list[_Ti1Preset] = [
    ...
    _Ti1Preset("redriver_i1pro_a4_2052p_4pages",
               ...
               layout_recipe=dict(_RR_I1PRO_A4_2052P_4PAGES)),
    _Ti1Preset("redriver_i1pro_letter_2052p_4pages",
               ...
               white=6, black=6, tiff_16bit=False, suffix=_REDRIVER_SUFFIX,
               group="Red River Paper",
               layout_recipe=dict(_RR_I1PRO_LETTER_2052P_4PAGES)),
    _Ti1Preset("redriver_colormunki_a4_2052p_8pages",
               ...
               white=6, black=6, tiff_16bit=False, suffix=_REDRIVER_SUFFIX,
               group="Red River Paper",
               layout_recipe=dict(_RR_COLORMUNKI_A4_2052P_8PAGES)),
    _Ti1Preset("redriver_colormunki_letter_2052p_8pages",
               ...
               white=6, black=6, tiff_16bit=False, suffix=_REDRIVER_SUFFIX,
               group="Red River Paper",
               layout_recipe=dict(_RR_COLORMUNKI_LETTER_2052P_8PAGES)),
    _Ti1Preset("redriver_colormunki_a4_2052p_9pages",
               "ColorMunki · A4-2052p-9pages" + _REDRIVER_SUFFIX,
               "CM", "A4", 1.0, 6, 9,
               ti1_asset=f"{_REDRIVER_DIR}/chart.ti1", patches=2052,
               white=6, black=6, tiff_16bit=False, suffix=_REDRIVER_SUFFIX,
               group="Red River Paper",
               layout_recipe=dict(_RR_COLORMUNKI_A4_2052P_9PAGES)),
    _Ti1Preset("redriver_colormunki_letter_2052p_9pages",
               "ColorMunki · Letter-2052p-9pages" + _REDRIVER_SUFFIX,
               "CM", "Letter", 1.0, 6, 9,
               ti1_asset=f"{_REDRIVER_DIR}/chart.ti1", patches=2052,
               white=6, black=6, tiff_16bit=False, suffix=_REDRIVER_SUFFIX,
               group="Red River Paper",
               layout_recipe=dict(_RR_COLORMUNKI_LETTER_2052P_9PAGES)),
    # --- i1Pro 3 Plus family (Knut, 2026-08-18) ---------------------------
...
class TabChart(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        left_layout.addWidget(TabHeader(
            ...
            tooltip_body=tr(
                ...
                "Checking a finished profile instead? When the bar at the top "
    ...
    def _make_manual_panel(self) -> QWidget:
        ...
        _eng_row.addWidget(TooltipButton(
            ...
            tr("When ON, ChromIQ builds your test charts itself instead of "
               ...
               "layout below per instrument and paper. The engine is the "
               "default for new charts; printtarg stays one untick away.\n\n"
    ...
    def _run_description_tooltip(self) -> str:
        ...
        return tr(
            ...
            "description in the tab where you build the profile — that tab is "
            "called “4. Build Profile”, or “4. Calibration & Profiling” when "
            "calibration options are switched on in Preferences — so the "
            "finished .icc carries it too. Unless you have written your own "
            "description there, which is never overwritten.\n\n"
