...
def readme(results: list, _lock_rows: "list[dict]", _cov: dict) -> str:
    ...
    a("")
    a("THREE ROWS CANNOT CROSS ALONE UNDER A STOCK COLUMN")
    a("--------------------------------------------------")
    a("")
    ...
    a("")
    a("The third is the grey-balance average, and the reason is worth knowing.")
    a("The grey rows are measured in chroma difference and the others in colour")
    a("difference, and near a neutral those are not the same size: a chroma")
    a("error of 1.8 IS a colour difference of 2.55, and one of 3.6 is 4.82")
    a("(measured, and it is CIEDE2000's own rescaling of a* at low chroma).")
    a("So a grey cast big enough to cross the recommended 1.5 already puts")
    a("every grey patch over 2.0, and the grey ramp is most of the worst 5 %")
    a("of these charts. Threshold-Series 2026-04-13 shows that honestly, with")
    a("two rows crossing.")
    a("")
