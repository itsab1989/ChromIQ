...
MESSAGE_DEMOS: "dict[str, list[str]]" = {
    ...
    # K37 (Knut, 5822758830): no demo sheet is a white-mapped print of a
...
def package_readme(m: dict, limit_readme: str, notes_lines: "list[str]",
    ...
    a("any printer. It holds no Fogra or Idealliance data and nobody's")
    a("private measurements; where a run is judged against ISO 12647-7 or")
    a("ISO 12647-8, the numbers are the values only that ChromIQ ships, with")
    a("no text, table or figure of either standard.")
    a("")
    a("THE PROJECTS")
    a("")
    for p in m["projects"]:
