...
CITATIONS: list[tuple[str, int, str]] = [
    ...
    ("ui/tabs/tab_chart.py", 8190, "_engine_capacity"),
    ("ui/tabs/tab_chart.py", 8198, "patches_per_sheet"),
    ("ui/tabs/tab_chart.py", 8275, "_update_patch_count"),
    ("ui/tabs/tab_chart.py", 10377, "_is_verification_target"),
    ("ui/tabs/tab_chart.py", 11630, "write_sidecars"),
