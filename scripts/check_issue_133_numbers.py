...
CITATIONS: list[tuple[str, int, str]] = [
    ...
    ("workflow/measurement_report.py", 327, "is_verification"),
    ("workflow/measurement_report.py", 395, "CORNER_PRESENT_TOL"),
    ...
    ("ui/tabs/tab_chart.py", 10152, "_is_verification_target"),
    ("ui/tabs/tab_chart.py", 10903, "write_sidecars"),
