...
CITATIONS: list[tuple[str, int, str]] = [
    ...
    ("ui/tabs/tab_chart.py", 8179, "_engine_capacity"),
    ("ui/tabs/tab_chart.py", 8187, "patches_per_sheet"),
    ("ui/tabs/tab_chart.py", 8264, "_update_patch_count"),
    ("ui/tabs/tab_chart.py", 10366, "_is_verification_target"),
    ("ui/tabs/tab_chart.py", 11504, "write_sidecars"),
