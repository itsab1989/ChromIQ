...
CITATIONS: list[tuple[str, int, str]] = [
    ...
    ("workflow/measurement_report.py", 609, "CORNER_PRESENT_TOL"),
    ...
    ("ui/tabs/tab_chart.py", 8233, "_engine_capacity"),
    ("ui/tabs/tab_chart.py", 8241, "patches_per_sheet"),
    ("ui/tabs/tab_chart.py", 8318, "_update_patch_count"),
    ("ui/tabs/tab_chart.py", 10420, "_is_verification_target"),
    ("ui/tabs/tab_chart.py", 11673, "write_sidecars"),
