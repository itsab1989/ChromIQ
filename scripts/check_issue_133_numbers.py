...
CITATIONS: list[tuple[str, int, str]] = [
    ...
    ("workflow/measurement_report.py", 464, "is_verification"),
    ("workflow/measurement_report.py", 612, "CORNER_PRESENT_TOL"),
    ...
    ("ui/main_window.py", 969, "_profile_building"),
    ("ui/measurement_target_bar.py", 767, "RUN_TYPE_VERIFICATION"),
    ("ui/tabs/tab_measure.py", 1277, "_verification_guard"),
    ("ui/tabs/tab_measure.py", 5058, "_verification_guard"),
    ("ui/tabs/tab_measure.py", 5133, "_verification_guard"),
    ("ui/tabs/tab_chart.py", 8242, "_engine_capacity"),
    ("ui/tabs/tab_chart.py", 8250, "patches_per_sheet"),
    ("ui/tabs/tab_chart.py", 8327, "_update_patch_count"),
    ("ui/tabs/tab_chart.py", 10429, "_is_verification_target"),
    ("ui/tabs/tab_chart.py", 11692, "write_sidecars"),
