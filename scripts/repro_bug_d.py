...
def main() -> int:
    ...
    r1.chart_ti2.write_text("c1"); (r1.dir / "Test-Profiling-P.tif").write_bytes(b"")
    r1.profile_icc.write_text("icc"); r1.measurement_ti3.write_text("m")
    r1.verifications_dir.mkdir(parents=True, exist_ok=True)
    r1.verify_chart_ti2.write_text("v")
    (r1.verifications_dir / "Test-Profiling-P-verify.tif").write_bytes(b"")
    r2 = proj.new_run(); r2.ensure_dir()
    r2.chart_ti2.write_text("c2"); (r2.dir / "Test-Profiling-P.tif").write_bytes(b"")
    r2.profile_icc.write_text("icc2"); r2.measurement_ti3.write_text("m2")
