...
def test_all_engine_options_roundtrip(app):
    ...
    r = LayoutRecipe(
        ...
        chart_text_bold=True, chart_text_italic=False,
        chart_text_align="between_margins", text_edge_mm=7.0,
    ...
    for f in ("instrument", "paper", "pscale", "sscale", "spacer_mode",
              ...
              "chart_text_italic", "chart_text_align",
              "text_edge_mm", "text_edge_top_mm",
