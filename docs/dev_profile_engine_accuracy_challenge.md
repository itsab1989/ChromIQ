...
| The cross-validated smoothing was a coin toss (×0.25 on the chart, ×4 on 90 % of it) and reported as a choice | | three splits, a margin above the criterion's scatter, ×1 otherwise; the log says when nothing won and when a pick sits at the ladder's end |
