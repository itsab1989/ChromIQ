...
### M-REPORT-SCOPE-RUN-DELETED · PROPOSED · Report Scope of a saved report that covered a profile run since deleted — Measurement Report (window and PDF)
...
### M-REPORT-NO-PAPER-PATCH · PROPOSED · the numbered note of a sheet whose chart has no paper patch — Measurement Report (window and PDF)
...
>
> This chart has no patch printed with no ink, so the paper white could not be measured, and nothing on this sheet is judged relative to the paper.
