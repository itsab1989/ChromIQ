...
### M-REPORT-SOLIDS-PREDICTED · PROPOSED · the numbered note on the two solid-colour rows, wherever they are compared with the profile's prediction · Measurement Report (window and PDF)
...
### M-REPORT-PAPER-AGAINST-PROFILE · PROPOSED · the numbered note on the paper row of a chart that is not FROM PROFILE GAMUT · Measurement Report (window and PDF)
