...
> {folder}
>
> Nothing was moved, and the report is still in the list. The usual reason is that the folder is read-only. Give yourself permission to change it, or copy the project somewhere you may write, and try again.
...
> {folders}
>
> A report is written whole or not at all, so nothing was changed. Give yourself permission to change that folder, or copy the project somewhere you may write, and try again.
