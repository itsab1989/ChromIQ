...
### M-REPORT-WORKED-OUT-EARLIER · PROPOSED · a saved report shown as an earlier version worked it out · Measurement Report, Report Scope (window and PDF)
...
differently. Our words; the behaviour follows §6.*

> **Worked out by an earlier version**
>
> This report was worked out by an earlier version of ChromIQ and is shown as it was saved. This version works some of its rows out differently; Update works the report out again.
