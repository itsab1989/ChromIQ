...
### M-REPORT-WORKED-OUT-DIFFERENTLY-UPDATE-OR-NEW · PROPOSED · Generate report, with a selected report, nothing changed, and this version working it out differently — Measurement Report
...
### M-REPORT-NEW-REPORT-SETTINGS · PROPOSED · the red line after "New report…" is chosen in "Report shown" — Measurement Report
